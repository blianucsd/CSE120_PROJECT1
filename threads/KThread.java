...
public class KThread {
	...
	private void runThread() {
		System.out.println("runThread: " + toString());
		begin();
		target.run();
		finish();
	}
	...
	public static void finish() {
		...
		System.out.println("Current in finish: " + currentThread);
		...
		if(currentThread.parent != null && currentThread.parent.status != statusReady) {
			System.out.println("currentThread: " + currentThread + " is readying parent: " + currentThread.parent);
	...
	public void ready() {
		...
		//System.out.println("readying: " + this.toString());
	...
	public void join() {
		...
		Lib.assertTrue(this != currentThread);
		System.out.println("this.joined: " + this.joined);
		...
		if(this.status == statusFinished) {
			...
			this.joined = true;
			System.out.println("currentThread in join: " + currentThread);
			this.parent = currentThread;
			//currentThread.count++;
			boolean intStatus = Machine.interrupt().disable();
			currentThread.sleep();
			Machine.interrupt().restore(intStatus);
			System.out.println("currentThread2 " + currentThread);
		}
		//Machine.interrupt().restore(intStatus);
	}
	...
	private static void runNextThread() {
		...
		//System.out.println("runNextThread: " + nextThread);
		if (nextThread == null)
	...
	protected void restoreState() {
		...
		//System.out.println("restoreState current: " + currentThread);
		...
		if (toBeDestroyed != null) {
			System.out.println("destroyed: " + toBeDestroyed);
	...
	private static void joinTest1 () {
		...
		System.out.println("OG Daddy " + child1.currentThread());
		...
		System.out.println("joinTest1 " + child1.currentThread());
		child1.join();
    ...
    //public static KThread t2 = new KThread(new B()).setName("B");
	...
	KThread t2 = new KThread(new B()).setName("B");
    	KThread t1 = new KThread(new A(t2)).setName("A");
	//System.out.println("main1: " + currentThread);
	...
	//t2.fork();
	t2.join();
	//System.out.println("main: " + tB.joined);
	//tB.join();
